...
export const metadata: Metadata = {
  ...
  keywords: "animly.vercel.app, animly, vercel animals, animal facts, wildlife, habitats, animal encyclopedia, nature, wildlife research, animal behaviors",
  openGraph: {
    title: "Animly - Modern Animal Encyclopedia",
    description: "Explore fascinating animal facts and behaviors with Animly, the ultimate wildlife resource.",
