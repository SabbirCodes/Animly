...
export default function AnimalCard({ name, id }: { name: string, id: number}) {
  return (
    <Link href={`/animal/${encodeURIComponent(name)}`}>
      <div key={id} className="border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-white hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700">
        <div className="p-6">
